...
trainer_ckpt_path = (
    "outputs/experiment/train/pancreas/ode_model_all_20240122_102418/model-final.pt"
)

model = RNAVeloNetConfig(dim=64, input_dim=668)

head_trainer = CellTypeClassifierTrainerConfig(
    dataset_name="pancreas",
    ann_prc_data="datasets/pretrain/pancreas/data/pancreas.h5ad",
...
perturb_trainer = PerturbationTrainerConfig(
    ...
    t_step=65,
    seq_step=5,
    data_folder="datasets/pretrain/pancreas/trajs/sampled_traj_train.npz",
    eval_data_folder="datasets/pretrain/pancreas/trajs/sampled_traj_val.npz",
    test_data_folder="datasets/pretrain/pancreas/trajs/sampled_traj_test.npz",
    ann_prc_data="datasets/pretrain/pancreas/data/pancreas.h5ad",
    ann_raw_data="datasets/pretrain/pancreas/data/pancreas.h5ad.raw",
    starting_cell_type="Pre-endocrine",
    train_only_starting_cell_type_data=True,
    cell_type_ratio_keys=["Alpha", "Beta"],
    deep_velo_model_checkpoint="outputs/pretrain/pancreas/model/autoencoder.pth",
    deep_velo_model_dim=668,
    deep_velo_scaling_factor=0.8170944342283816,
