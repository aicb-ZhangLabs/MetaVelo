...
from src.dataset import MNISTSubset
from src.head.base import HeadModule
from src.pert import PertModule
from src.train.base import BaseTrainer
from src.utils import cycle_dataloader, divisible_by, visualize_changed_mnist_digit
...
class MNISTFIMAPPerturbationTrainer(MNISTPerturbationTrainer):
    def _get_pert_model_dataset(self, dl: DataLoader) -> torch.Tensor:
        xs = []
        for data, *_ in dl:
            data = data.to(self.device)
