...
class TriggerPertModule(PertModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.trigger_model: BaseTriggerPerturbation = (
            self._dispatch_trigger_perturbation(
                ...
                init_pert_ind=(
                    torch.LongTensor(init_pert_ind) if init_pert_ind else None
                ),
    ...
    def get_importance_val(self, **kwargs) -> torch.Tensor:
        raise Exception("Trigger perturbation does not support importance value")
